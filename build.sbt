...
lazy val publishingSettings = Seq(
  ...
  pomExtra :=
    <url>https://github.com/scalajs-io/tingodb</url>
      <licenses>
        <license>
      ...
      <scm>
        <connection>scm:git:github.com/scalajs-io/tingodb.git</connection>
        <developerConnection>scm:git:git@github.com:scalajs-io/tingodb.git</developerConnection>
        <url>github.com/scalajs-io/tingodb.git</url>
      </scm>
      <developers>
        <developer>
          <id>ldaniels528</id>
